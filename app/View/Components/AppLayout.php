    ...
    private function navigationFor(User $user, int $unreadNotificationCount): array
    {
        ...
        if ($user->hasRole('admin')) {
            return [
                ...
                $this->item('Members', 'admin.members.index', ['admin.members.index', 'admin.members.show'], null, 'People'),
                $this->item('Memberships', 'admin.memberships.index', ['admin.memberships.*'], null, 'Services'),
                ...
                $this->item('Game Levels', 'admin.game-levels.index', ['admin.game-levels.*', 'admin.game-goals.*'], null, 'Progression'),
